        ...
        AnimatedVisibility(!started, enter = fadeIn(), exit = fadeOut()) {
            Box(Modifier.fillMaxSize(), contentAlignment = Alignment.Center) {
                Button(
                    ...
                    Text(stringResource(R.string.ui_125), fontWeight = FontWeight.Black)
                }
            }
        }
        ...
        AnimatedVisibility(started && finished, enter = fadeIn(tween(350)), exit = fadeOut()) {
            Box(
                ...
                Column(horizontalAlignment = Alignment.CenterHorizontally) {
                    ...
                    Text(stringResource(R.string.ui_127), color = GameGateText)
                    ...
                    Button(
                        ...
                        Text(stringResource(R.string.ui_126), fontWeight = FontWeight.Black)
                    }
                }
            }
        }
